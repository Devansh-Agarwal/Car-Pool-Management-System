...
public class RideRequestActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.rMap);
        mSource = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.rSource);
        mDestination = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.rDestination);
        ...
        mSource.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(@NonNull Status status) {
                Toast.makeText(RideRequestActivity.this, "select start address", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mDestination.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            @Override
            public void onError(@NonNull Status status) {
                Toast.makeText(RideRequestActivity.this, "select end address", Toast.LENGTH_SHORT).show();
            }
        });
...
//        handling post ride button
        mFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(finalSource==null){
                    Toast.makeText(RideRequestActivity.this, "Enter start address", Toast.LENGTH_SHORT).show();
                }
                else if(finalDest==null){
                    Toast.makeText(RideRequestActivity.this, "Enter end address", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(date)){
                    Toast.makeText(RideRequestActivity.this, "Enter date", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(time)){
                    Toast.makeText(RideRequestActivity.this, "Enter time", Toast.LENGTH_SHORT).show();
                }
...
//            super.onPreExecute();
//            progressDialog = new ProgressDialog(RideRequestActivity.this);
...
//                    SupportMapFragment supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
                    ...
                    mapFragment.getMapAsync(RideRequestActivity.this);
                }
            }
        });
    }
